  ...
  render () {
    return (
      <>
        <Title
          title={'Privacy - typ'}
          description={'You are the customer, not the product.'}
          url={'https://typapp.co/privacy'}
          image={null}
        />
        <div style={{ minHeight: '100%' }}>
          <section id='privacy' className='mt-3 pt-5 w-100 d-table'>
            <div className='container-fluid d-table-cell'>
              <div className='container-fluid'>
                ...
                <ul>
                  <li>
                    <p className='mb-0 pb-0'>Discord Account</p>
                ...
                <h3 className='font-weight-bold'>Use of Data</h3>
                <p>Points uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>Points will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                <h3 className='font-weight-bold'>Disclosure Of Data</h3>

                <h3>Legal Requirements</h3>
                <p>Points may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Points</li>
                    <li>To prevent or investigate possible wrongdoing in connection with the Service</li>
                    <li>To protect the personal safety of users of the Service or the public</li>
                    <li>To protect against legal liability</li>
                </ul>

                <h3 className='font-weight-bold'>Security Of Data</h3>
                <p>The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>

                <h3 className='font-weight-bold'>Service Providers</h3>
                <p>We may employ third party companies and individuals to facilitate our Service ("Service Providers"), to provide the Service on our behalf, to perform Service-related services or to assist us in analyzing how our Service is used.</p>
                <p>These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.</p>

                <h3 className='font-weight-bold'>Links To Other Sites</h3>
